...
if (preg_match('/[^\-0-9]/', $date)) {
    //$date = "1960-01-03";
    echo '<div id="results"><p>'.$date.'</p></div>';
...
$json = retrieve_wikidata($date, $language);
...
foreach($json as $item) {
    ...
    // CONZEPT PATCH
    // http://www.wikidata.org/entity/Q521168
    $qid = strstr($url, 'Q');
    $url = 'https://conze.pt/explore/?l=' . $language . '&t=wikipedia-qid&s=false&i=' . $qid ;
		$summary = '<p><a href="javascript:void(0)" onclick="parent.document.getElementById(&quot;infoframeSplit2&quot;).src =&quot;' . $url . '&quot;">'.$entity."</a> &mdash; <small>".$description.'</small></p>';
...
if (!(empty($birth))) {
	...
	echo '<h3>Birth</h3><div class="section">';
...
if (!(empty($death))) {
	...
	echo '<h3>Death</h3><div class="section">';
...
if (!(empty($inception))) {
	...
	echo '<h3>Inception/Foundation</h3><div class="section">';
...
if (!(empty($discovery))) {
	...
	echo '<h3>Discovery</h3><div class="section">';
...
if (!(empty($disparition))) {
	...
	echo '<h3>Disparition/Dissolution</h3><div class="section">';
...
if (!(empty($publication))) {
	...
	echo '<h3>Publication/Release</h3><div class="section">';
...
if (!(empty($performance))) {
	...
	echo '<h3>Performance</h3><div class="section">';
